Consensus package includes the intelchain BFT consensus protocol code, which uses BLS-based
multi-signature to cosign the new block. The details are
in intelchain's new [consensus protocol design](https://talk.intelchain.network/t/bls-based-practical-bft-consensus/131).

## Introduction to intelchain BFT with BLS signatures

intelchain BFT consensus protocol consist of normal mode and view changing mode which is same
