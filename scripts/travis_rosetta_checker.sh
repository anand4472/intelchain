...
cd "${GOPATH}/src/github.com/zennittians/intelchain-test"
...
docker run -v "$DIR/../:/go/src/github.com/zennittians/intelchain" intelchainitc/localnet-test -r
