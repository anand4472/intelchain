...
var file_msg_proto_goTypes = []interface{}{
	...
	(*Response)(nil),                  // 8: intelchain.stream.sync.message.Response
	(*ErrorResponse)(nil),             // 9: intelchain.stream.sync.message.ErrorResponse
	(*GetBlockNumberResponse)(nil),    // 10: intelchain.stream.sync.message.GetBlockNumberResponse
	(*GetBlockHashesResponse)(nil),    // 11: intelchain.stream.sync.message.GetBlockHashesResponse
	(*GetBlocksByNumResponse)(nil),    // 12: intelchain.stream.sync.message.GetBlocksByNumResponse
	(*GetBlocksByHashesResponse)(nil), // 13: intelchain.stream.sync.message.GetBlocksByHashesResponse
	(*GetNodeDataResponse)(nil),       // 14: intelchain.stream.sync.message.GetNodeDataResponse
	(*Receipts)(nil),                  // 15: intelchain.stream.sync.message.Receipts
	(*GetReceiptsResponse)(nil),       // 16: intelchain.stream.sync.message.GetReceiptsResponse
	nil,                               // 17: intelchain.stream.sync.message.GetReceiptsResponse.ReceiptsEntry
}
var file_msg_proto_depIdxs = []int32{
	1,  // 0: intelchain.stream.sync.message.Message.req:type_name -> intelchain.stream.sync.message.Request
	8,  // 1: intelchain.stream.sync.message.Message.resp:type_name -> intelchain.stream.sync.message.Response
	...
	9,  // 8: intelchain.stream.sync.message.Response.error_response:type_name -> intelchain.stream.sync.message.ErrorResponse
	10, // 9: intelchain.stream.sync.message.Response.get_block_number_response:type_name -> intelchain.stream.sync.message.GetBlockNumberResponse
	11, // 10: intelchain.stream.sync.message.Response.get_block_hashes_response:type_name -> intelchain.stream.sync.message.GetBlockHashesResponse
	12, // 11: intelchain.stream.sync.message.Response.get_blocks_by_num_response:type_name -> intelchain.stream.sync.message.GetBlocksByNumResponse
	13, // 12: intelchain.stream.sync.message.Response.get_blocks_by_hashes_response:type_name -> intelchain.stream.sync.message.GetBlocksByHashesResponse
	14, // 13: intelchain.stream.sync.message.Response.get_node_data_response:type_name -> intelchain.stream.sync.message.GetNodeDataResponse
	16, // 14: intelchain.stream.sync.message.Response.get_receipts_response:type_name -> intelchain.stream.sync.message.GetReceiptsResponse
	17, // 15: intelchain.stream.sync.message.GetReceiptsResponse.receipts:type_name -> intelchain.stream.sync.message.GetReceiptsResponse.ReceiptsEntry
	15, // 16: intelchain.stream.sync.message.GetReceiptsResponse.ReceiptsEntry.value:type_name -> intelchain.stream.sync.message.Receipts
