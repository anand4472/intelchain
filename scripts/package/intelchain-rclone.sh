...
rclone --config "${CONFIG}" sync -vvv "itc:pub.intelchain.network/${FOLDER}/intelchain_db_${SHARD}" "${DATADIR}/archive/intelchain_db_${SHARD}" > "${DATADIR}/archive/archive-${SHARD}.log" 2>&1
