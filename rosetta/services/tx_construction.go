...
import (
	...
	types2 "github.com/intelchain-itc/intelchain/staking/types"
...
type TransactionMetadata struct {
	...
	Logs                      []*itcTypes.Log          `json:"logs,omitempty"`
...
) (response itcTypes.PoolTransaction, rosettaError *types.Error) {
...
func constructCrossShardTransaction(
	components *OperationComponents, metadata *ConstructMetadata, sourceShardID uint32,
) (itcTypes.PoolTransaction, *types.Error) {
	...
	return itcTypes.NewCrossShardTransaction(
...
func constructContractCreationTransaction(
	...
	return itcTypes.NewContractCreation(
...
func constructPlainTransaction(
	...
	return itcTypes.NewTransaction(
