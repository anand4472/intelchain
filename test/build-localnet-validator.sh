...
itc --node="http://localhost:9500" staking create-validator \
    --validator-addr itc... --amount 10000 \
...
itc --node="http://localhost:9500" staking create-validator \
    --validator-addr itcc... --amount 10000 \
...
itc --node="http://localhost:9500" staking create-validator \
    --validator-addr itccc... --amount 10000 \
...
itc blockchain validator information itc.. --node="http://localhost:9500"
itc blockchain validator information itc.. --node="http://localhost:9500"
itc blockchain validator information itc.. --node="http://localhost:9500"
itc blockchain validator information itc.. --node="http://localhost:9500"
'''
